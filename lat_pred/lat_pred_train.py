...
from utils import Net, b_arch_to_feat, h_arch_to_feat, predictor_args
...
if __name__ == '__main__':
    ...
    if not os.path.exists("trained_lat_pred"):
        os.mkdir("trained_lat_pred")
        
    torch.save(net.state_dict(), os.path.join(f"trained_lat_pred/{target}_{pred_target}.pt"))