...
from yolov7_utils.autoanchor import check_anchors
from yolov7_utils.datasets import create_dataloader
from yolov7_utils.general import labels_to_class_weights, increment_path, labels_to_image_weights, init_seeds, \
...
from yolov7_utils.plots import plot_images, plot_labels, plot_results, plot_evolution
from yolov7_utils.torch_utils import ModelEMA, select_device, intersect_dicts, torch_distributed_zero_first, is_parallel
from yolov7_utils.wandb_logging.wandb_utils import WandbLogger, check_wandb_resume
...
if __name__ == '__main__':
    ...
    parser.add_argument('--project', default='runs/finetune', help='save to project/name')
    ...
    if not opt.evolve:
        ...
        finetune(hyp, opt, device, tb_writer)
    ...
    # Evolve hyperparameters (optional)
        ...
        for _ in range(300):  # generations to evolve
            ...
            # Train mutation
            results = finetune(hyp.copy(), opt, device)
